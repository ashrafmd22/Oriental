        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-white p-6 rounded-lg shadow-md"> {/* Reduced padding (p-8 to p-6) */}
          ...
          <div>
            ...
            <div className="mt-6"> {/* Reduced margin-top (mt-8 to mt-6) */}
              ...
              <a
                href={`https://wa.me/8810418134?text=Hello!%20I'm%20interested%20in%20the%20following%20product:%0A%0AName:%20${product.name}%0ACode:%20${product.code}%0AImage:%20${product.images[0]}%0A%0AIf%20you%20have%20more%20details,%20please%20share.`}
                target="_blank"
