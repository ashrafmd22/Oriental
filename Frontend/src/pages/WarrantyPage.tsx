    ...
    >
      <div className="space-y-8 overflow-x-hidden px-1 sm:px-4 lg:px-8">
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-slate-800">1. Warranty Coverage</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-slate-800">2. Warranty Exclusions</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-slate-800">3. Warranty Duration</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-slate-800">4. How to Claim Warranty</h2>
