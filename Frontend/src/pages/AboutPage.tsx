    ...
    <div className="pt-20">
      ...
      <section className="relative h-[400px] bg-gradient-to-r from-blue-700 to-blue-900 text-white">
        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 flex items-center justify-center text-center">
          <div className="z-10">
            <h1 className="text-6xl font-extrabold mb-6 leading-tight tracking-wide">Our Story</h1>
      ...
      {/* Legacy Section */}
      <section id="legacy" className="py-28 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-5xl font-extrabold text-gray-800 mb-6">Our Legacy of Excellence</h2>
            ...
            <div className="grid grid-cols-1 gap-6">
              <img
                ...
                alt="Team"
                className="rounded-xl shadow-xl transform transition duration-300 hover:scale-105"
              />
              <img
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              >
                ...
                <h3 className="text-2xl font-semibold mb-4 group-hover:text-blue-600 transition duration-300">
                  {value.title}
                </h3>
