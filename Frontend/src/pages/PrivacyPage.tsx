    ...
    >
      <div className="space-y-8 overflow-x-hidden px-1 sm:px-4 lg:px-8">
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-slate-800">1. Information Collection</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-slate-800">2. Use of Information</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-slate-800">3. Data Sharing</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-slate-800">4. Data Security</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-slate-800">5. Cookies and Tracking Technologies</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-slate-800">6. Your Rights</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-slate-800">7. Changes to This Privacy Policy</h2>
