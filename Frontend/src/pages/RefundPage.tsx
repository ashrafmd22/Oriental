    ...
    >
      <div className="space-y-8 overflow-x-hidden px-1 sm:px-4 lg:px-8">
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-gray-800">1. Refund Policy</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-gray-800">2. Cancellation Policy</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-gray-800">3. Refund Eligibility</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-gray-800">4. How to Request a Refund</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-gray-800">5. Refund Method</h2>
