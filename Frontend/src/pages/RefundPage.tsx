    ...
    >
      <div className="space-y-8 overflow-x-hidden px-1 sm:px-4 lg:px-8">
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-slate-800">1. Refund Policy</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-slate-800">2. Cancellation Policy</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-slate-800">3. Refund Eligibility</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-slate-800">4. How to Request a Refund</h2>
          <div className="bg-purple-50 rounded-xl p-4 sm:p-6">
            <ul className="list-decimal pl-6 space-y-3 text-slate-700">
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-slate-800">5. Refund Method</h2>
