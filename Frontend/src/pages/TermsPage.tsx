    ...
    >
      <div className="space-y-8 overflow-x-hidden px-1 sm:px-4 lg:px-8">
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-slate-800">1. Acceptance of Terms</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-slate-800">2. User Responsibilities</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-slate-800">3. Account Termination</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-slate-800">4. Privacy Policy</h2>
          <div className="bg-indigo-50 rounded-xl p-4 sm:p-6">
            <h3 className="font-semibold mb-3">Data Collection and Use:</h3>
            <p className="text-slate-700">
              We respect your privacy and are committed to protecting your personal information. Please refer to our <strong><a href="/privacy" className="text-indigo-600">Privacy Policy</a></strong> for more details on how we collect, use, and protect your data.
            </p>
          </div>
        </section>

        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-slate-800">5. Limitation of Liability</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-slate-800">6. Changes to Terms</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-slate-800">7. Governing Law</h2>
          <div className="bg-slate-50 rounded-xl p-4 sm:p-6">
