  ...
  return (
    ...
    >
      <div className="space-y-8 overflow-x-hidden px-1 sm:px-4 lg:px-8">
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-gray-800">2. User Responsibilities</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-gray-800">3. Account Termination</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-gray-800">4. Privacy Policy</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-gray-800">5. Limitation of Liability</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-gray-800">6. Changes to Terms</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold text-gray-800">7. Governing Law</h2>
          <div className="bg-gray-50 rounded-xl p-4 sm:p-6">
